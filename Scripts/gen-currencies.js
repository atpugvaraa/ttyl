#!/usr/bin/env node
// Generate ttyl/Features/Calculator/Model/CurrencyData.generated.swift.
//
...
async function main() {
  ...
  const out = path.resolve(__dirname, "..", "ttyl/Features/Calculator/Model/CurrencyData.generated.swift");
