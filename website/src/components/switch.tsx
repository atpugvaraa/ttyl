        ...
        <Reveal delay={80} className="order-1 lg:order-2">
          <figure className="w-full overflow-hidden rounded-2xl shadow-window">
            <img
              ...
              width={1800}
              height={1192}
              alt="ttyl's Import from Raycast screen, with Shortcuts, Favorites, Emoji skin tone, Launch at login, Menu-bar icon, and Clipboard history all selected to import."
