// Drives the "ttyl in action" gallery + lightbox. Each item is a tile in
...
export const galleryItems: GalleryItem[] = [
  {
    type: "video",
    src: "ttyl-in-action.mp4",
    poster: "screenshot.png",
    title: "ttyl in action",
  ...
  },
  {
    ...
    caption: "No Pro tier — keep your full history as long as you like.",
    width: 2226,
    height: 1604,
  },
  {
