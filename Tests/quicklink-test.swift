...
struct QuicklinkTests {
    ...
    static let home = "/Users/ttyl-harness"
    ...
    static func pathDetection() {
        ...
        expect(
            detect("  ~/Projects/ttyl  ") == .path("\(home)/Projects/ttyl"),
    ...
    static func scratchDirectory() -> URL {
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("ttyl-quicklink-test-\(UUID().uuidString)", isDirectory: true)
