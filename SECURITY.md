...
Include your macOS version, the ttyl version and channel, reproduction steps, and the impact.
...
Current stable and beta only. Update (`brew upgrade --cask ttyl`) before reporting.
...
- **Network** — ttyl is offline by default and every networked feature is consent-gated. A path
