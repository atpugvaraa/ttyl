...
private struct AboutLink: Identifiable {
    ...
    static let all: [AboutLink] = [
        AboutLink(
            ...
            detail: "atpugvaraa.github.io/ttyl",
            url: URL(string: "https://atpugvaraa.github.io/ttyl/")!),
        AboutLink(
            id: "github", glyph: .brand("BrandGitHub"), title: "GitHub",
            detail: "github.com/atpugvaraa/ttyl",
            url: URL(string: "https://github.com/atpugvaraa/ttyl")!),
        AboutLink(
            id: "discord", glyph: .brand("BrandDiscord"), title: "Discord",
            detail: "Join the ttyl community",
            url: URL(string: "https://discord.gg/v2Eeb4QQy3")!),
        AboutLink(
            id: "x", glyph: .brand("BrandX"), title: "X", detail: "@atpugvaraa",
            url: URL(string: "https://x.com/atpugvaraa")!),
        AboutLink(
            id: "email", glyph: .symbol("envelope"), title: "Email",
            detail: "atpugvaraa@gmail.com", url: URL(string: "mailto:atpugvaraa@gmail.com")!)
    ]
}
