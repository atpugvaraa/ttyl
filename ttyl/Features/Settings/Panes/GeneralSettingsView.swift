...
struct GeneralSettingsView: View {
    ...
    private var hyperSubtitle: String {
        ...
        return
            ...
            + " Hyper Key shortcuts are shown in ttyl with ✦."
    }
    ...
    var body: some View {
        ...
        return Form {
            ...
            Section {
                ...
                Text(
                    "ttyl privately learns which results you choose for each query. Reset all learned choices to restore the default order."
                )
                .font(.caption)
                .foregroundStyle(.secondary)
            }
            ...
            Section {
                ...
                if hyperTap.status == .needsAccessibility {
                    LabeledContent {
                        ...
                        Label(
                            "ttyl needs Accessibility access to remap keys.",
            ...
            Section {
                Toggle(isOn: $settings.launchAtLogin) {
                    ...
                    Text("Start ttyl automatically when you log in.")
                }
                Toggle(isOn: $showInMenuBar) {
                    Text("Show in menu bar")
                    Text("Keep the ttyl icon in the menu bar. Shortcuts still work when hidden.")
                }
        ...
        .confirmationDialog(
            ...
            Text("ttyl will relearn your preferred results as you use the launcher.")
        }
    }
}
