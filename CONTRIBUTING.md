# Contributing to ttyl

Check existing [issues](https://github.com/atpugvaraa/ttyl/issues) and
[pull requests](https://github.com/atpugvaraa/ttyl/pulls) first.
...
- **No bloat.** ttyl stays small on purpose — quality over quantity. A clean patch still gets
...
- `open ttyl.xcodeproj` → ⌘R. Debug builds are their own channel (`ttyl Dev.app`).
...
macOS version, ttyl version + channel, steps, expected vs actual. A recording beats a paragraph.
